...
<div class="container-fluid featureContainer">
    <div class="container fw-bold">
      <p class="q_para text-uppercase">Privacy Policy</p>
    </div>
  </div>
  <section class="infoConainer mt-5"></section>
  <div class="termsContainer">
    <div class="conditionsPara">
      <p>
        ...
        it to determine whether each party acted within their rights. Creating
        the best terms and conditions page possible will protect your business
        from the following:
      </p>
      <ul>
        <li>
          Abusive users: Terms and Conditions agreements allow you to
          establish what constitutes appropriate activity on your site or app,
          empowering you to remove abusive users and content that violates
          your guidelines.
        </li>
        <li>
